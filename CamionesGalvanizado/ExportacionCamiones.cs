...
{
    public partial class ExportacionCamiones : Form
    {

        DBUtils dbu = new DBUtils();

        public ExportacionCamiones()
        {
            InitializeComponent();
        }
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            this.dgvCamiones.DataSource = dbu.obtenerAlmacenes(this.tbCodBarras.Text);
            dgvCamiones.ColumnHeadersDefaultCellStyle.BackColor = Color.Yellow;
        ...
        private void btnExportar_Click(object sender, EventArgs e)
        {
            ...
            string dgvToHTMLTable = ConvertDataGridViewToHTMLWithFormatting(this.dgvCamiones);
        ...
        {
            dgvCamiones.SelectAll();
            DataObject dataObj = dgvCamiones.GetClipboardContent();
            if (dataObj != null)
            {
        ...
        public string DGVHeaderCellToHTMLWithFormatting(DataGridView dgv, int col)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("<td");
            sb.Append(DGVCellColorToHTML(dgv.Columns[col].HeaderCell.Style.ForeColor, Color.Yellow));
