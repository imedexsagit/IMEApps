...
namespace InventarioTablets
{
    public partial class Tornilleria : Form
    {
        ...
        public Tornilleria(String emp, Int32 anio, String cad, String disp, /*Int32 min, Int32 max,*/ String mat, String lugar)
        {
            InitializeComponent();
        ...
        private void Tornilleria_Load(object sender, EventArgs e)
        {
        ...
        private Boolean existeTornillo(String codigo)
        {
            try
            {
                this.conn.Open();
                ...
                strSql += "         WHERE (CodEmp = '" + this.CodEmp + "') AND (Codigo = '" + codigo + "') AND (Familia = 'TO') ";
            ...
            {
                MessageBox.Show("Error al comprobar la existencia del Tornillo: " + ex.Message, "ATENCIÓN", MessageBoxButtons.OK, MessageBoxIcon.Exclamation, MessageBoxDefaultButton.Button1);
                return false;
            }
            finally
            {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                if (existeTornillo(textBox3.Text) == false)
                {
                    MessageBox.Show("El Tornillo no existe, hable con el Dpto de Compras", "Error", MessageBoxButtons.OK, MessageBoxIcon.Exclamation, MessageBoxDefaultButton.Button1);
                    this.textBox3.Text = String.Empty;
                    this.textBox3.Focus();
                    return;
                }
        ...
        private void Tornilleria_Closed(object sender, EventArgs e)
        {
            if (conn != null)
        ...
        private void btnHistorial_Click(object sender, EventArgs e)
        {
            ...
            string strsql = "";
            strsql = strsql + " select distinct Taco as TACO, ficha AS FICHA, Codigo, Cantidad, fechaC AS FECHA from TC_Inventario_contado where Categoria = 'TO' and Ano = '" + AnioInventario + "' and Centro like '" + Lugar + "' and usuarioC = '" + this.PDA + "'";
