...
{
    public partial class Galvanizado : Form
    {
        ...
        */
        ...
        public Galvanizado(String emp, Int32 anio, String cad, String disp, /*Int32 min, Int32 max,*/ String mat, String lugar)
        {
            this.CodEmp = emp;
        ...
        private void Galvanizado_Load(object sender, EventArgs e)
        {
        ...
        private void Galvanizado_Closed(object sender, EventArgs e)
        {
            if (conn != null)
        ...
        private void btnHistorial_Click(object sender, EventArgs e)
        {
            ...
            string strsql = "";
            strsql = strsql + " select distinct Taco as TACO, ficha AS FICHA, concat(73, maquina) AS [PAQUETE GALVA], Tipo AS TIPO, fechaC AS FECHA from TC_Inventario_contado where Categoria = 'EM' and tipo = 'Blanco' and Ano = '" + AnioInventario + "' and Centro like '" + Lugar + "' and usuarioC = '" + this.PDA + "'";
